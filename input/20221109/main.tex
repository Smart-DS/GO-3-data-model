...
\date{ Nov 4, 2022 - v1.1.0 
\\
{\color{red}Breaking changes on violation costs}
}
...
{\color{red}\tt e\_vio\_cost} & Energy violation costs for energy constraint violation in \$/pu-h (Float) & Y & S &$c^{e}$  \\
\hline
\end{tabular}
\end{center}
