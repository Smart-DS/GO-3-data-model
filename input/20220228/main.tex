...
\begin{tabular}{ l | l | c | c | c |}
  ...
  {\tt p\_syn\_res\_ub}           & Maximum synchronized reserve (Float, p.u.) & Y & S &{\color{red} $p^{spr,max}$}\\ 
  {\tt p\_nsyn\_res\_ub}          & Maximum non-synchronized reserve (Float, p.u.) & Y & S &{\color{red} $p^{nsp,max}$}\\   
  ...
  {\tt q\_res\_up\_ub} & Maximum reactive reserve up (Float, p.u.) & Y & S & $q^{qru, max}$\\ 
  {\tt q\_res\_down\_ub} & Maximum reactive reserve down (Float, p.u.) & Y & S & $q^{qrd, max}$\\
  \hline
  ...
  {\tt p\_syn\_res\_cost}        & Costs for synchronized reserve (Float, \$/pu-h) & Y & S &{\color{red} $c^{spr}$}\\ 
  {\tt p\_nsyn\_res\_cost}       & Costs for non-synchronized reserve (Float, \$/pu-h) & Y & S &{\color{red} $c^{nsp}$}\\   
...
%  &  FLEXI-RAMP-UP, FLEXI-RAMP-DOWN ) &  & & \\
  ...
  {\tt SYN} & Synchronized reserve requirement (Fraction, Float) & Y & T & {\color{red} $\sigma^{spr}$} \\
  {\tt NSYN} & Non-synchronized reserve requirement (Fraction, Float) & Y & T & {\color{red} $\sigma^{nsp}$} \\
  ...
  {\tt SYN\_vio\_cost} & Synchronized reserve violation cost (\$/pu-hr, Float) & Y & S & {\color{red} $c^{spr}$} \\
  {\tt NSYN\_vio\_cost} & Non-synchronized reserve violation cost (\$/pu-hr, Float) & Y & S & {\color{red} $c^{nsp}$} \\
