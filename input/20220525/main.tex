...
\hline
  ...
  {\tt interval\_duration} & Time duration of the intervals, per time period in hours & Y & T & $d_t$ \\
                           & (Array of Float) &  &  & \\
                           \hline
                           {\tt timestamp\_start} & Period beginning timestamp for the first interval with Timestamp format YYYY-MM-DDThh:mm at UTC (String) & N & S & \\
                           {\tt timestamp\_stop} & Period beginning timestamp for the interval following the last interval with Timestamp format YYYY-MM-DDThh:mm at UTC (String) & N & S & \\
\hline
